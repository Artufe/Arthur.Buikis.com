...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-[1600px] px-6 py-24 lg:px-16 lg:py-32 min-h-[60vh] flex flex-col justify-center">
      <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[var(--muted)]">404</p>
      <h1 className="mt-4 font-display text-6xl lg:text-8xl leading-[1.02]">Not here.</h1>
