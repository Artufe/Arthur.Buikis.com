...
export const cvExperience: CVExperience[] = [
  {
    ...
    bullets: [
      ...
      'Took the platform from Django 3.2 / Python 3.9 to Django 5.2 / Python 3.13 in planned steps — each upgrade shipped as its own release, deprecation warnings cleared before every hop, soak time in production between moves. The whole ladder landed without a single incident.',
